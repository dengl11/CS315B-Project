...
class DataframePreprocessor:
    ...
    def transform_category(self, feature, rule_dic):
        ...
        """
        print("Before Transform: {}".format(self.unique_vals_for_feature(feature)))
        fn = lambda x: rule_dic[x] if x in rule_dic else x
        self._dataframe[feature] = np.vectorize(fn)(self._dataframe[feature])
        print("After Transform:  {}".format(self.unique_vals_for_feature(feature)))
    ...
    def reorder_columns(self, column_arr):
        """reorder columns by given order
        Args:
            column_arr: 

        Return: 
        """
        self._dataframe = self._dataframe[column_arr]
    ...
    def shuffle_rows(self):
        ...
        Return: 
        """
        self._dataframe = sklearn.utils.shuffle(self._dataframe)
